...
import com.example.yankaibang.bike.model.ControllerState;
import com.example.yankaibang.bluetooth.util.ByteUtil;
import com.example.yankaibang.entity.BControllerState;
import com.example.yankaibang.entity.W207State;

import java.util.Arrays;

import static com.example.yankaibang.bike.util.StateUpdateHelper.bitResolver;
import static com.example.yankaibang.bike.util.StateUpdateHelper.byteArrayToInt;
import static com.example.yankaibang.bike.util.StateUpdateHelper.byteToBitArray;
import static com.example.yankaibang.bike.util.StateUpdateHelper.updateBaseStation;
import static com.example.yankaibang.bike.util.StateUpdateHelper.updateLocation;
import static com.example.yankaibang.bike.util.StateUpdateHelper.updateSignal;
import static com.example.yankaibang.bike.util.StateUpdateHelper.updateVoltage;
